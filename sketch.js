...
function initialiseElements() {
  if (pageNo === 1) {
    ...
    button_shuffled.mousePressed(() => {
      init(algorithms[select_algorithm.value()], parseInt(input_count.value()));    //sending
      shuffle(array, true);                         //algorithm and input_count to init() and
    });                                             // calling shuffle() to shuffle the array
